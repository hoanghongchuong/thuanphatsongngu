    ...
    <div class="box">
      @include('admin.messages_error')
        <div class="box-body">
          ...
          <form name="frmAdd" method="post" action="{!! route('admin.vieclam.postAdd') !!}" enctype="multipart/form-data">
                          ...
                          <div class="row">
                            <div class="col-md-12 col-xs-12">
                              ...
                              <div class="box box-info">
                                  ...
                                  <textarea name="content" id="txtContent" cols="50" rows="5"></textarea>
                                </div>
                              </div>
                            </div>
                          </div>
