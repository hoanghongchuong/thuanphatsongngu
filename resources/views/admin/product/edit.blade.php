	                  		...
	                  		<div class="row">
								...
								<div class="col-md-12 col-xs-12">
									...
									<!-- <div class="form-group">
								      	...
								      	<textarea name="txtContent" rows="5" id="txtContent" class="form-control">{{ $data->mota }}</textarea>
									</div> -->
								</div>
							</div>
							<div class="clearfix"></div>
							...
							<div class="row">
								<div class="col-md-12 col-xs-12">
									<div class="form-group">
										...
										<textarea name="mota_en" rows="5" id="txtContent" class="form-control">{!! isset($data) ? $data->mota_en : '' !!}</textarea>
									</div>
