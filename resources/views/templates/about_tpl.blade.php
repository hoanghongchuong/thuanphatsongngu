        ...
        <nav class="container">
            <div class="vk-breadcrumb__wrapper">
                <ul class="vk-list vk-list--inline vk-breadcrumb__list">
                    ...
                    <li class="vk-list__item active">@if($lang == 'vi') {{$biendich[5]->name_vi}} @elseif($lang == 'en') {{$biendich[5]->name_en}}  @endif</li>
                </ul>
            </div>
            ...
            <div class="row">
                <div class="col-lg-9">
                    <div class="vk-news__left">
                        <h1 class="vk-page__heading vk-page__heading--news-detail">  @if($lang == 'vi') {!! $about->name !!} @elseif($lang == 'en') {!! $about->name_en !!} @endif</h1>
                        <p class="vk-news-item__meta vk-news-item__meta--detail"><span><i class="fa fa-user"></i> Post by: JSC Thuận Đức</p>

                        <div class="vk-news-detail__content">
                            @if($lang == 'vi') {!! $about->content !!} @elseif($lang == 'en') {!! $about->content_en !!} @endif


                        </div> <!--./news-content-->

                        <!-- <div class="vk-news__related">
                            <h3 class="vk-news-related__heading">Các bài viết liên quan</h3>
                            <ul class="vk-list vk-list--style-2">
                                <li class="vk-list__item"><a href="news-detail.html" title="">Lễ bốc thăm trúng thưởng
                                    chương trình mừng sinh nhật 2015</a></li>
                                <li class="vk-list__item"><a href="news-detail.html" title="">Lễ bốc thăm trúng thưởng
                                    chương trình mừng sinh nhật 2015</a></li>
                                <li class="vk-list__item"><a href="news-detail.html" title="">Lễ bốc thăm trúng thưởng
                                    chương trình mừng sinh nhật 2015</a></li>
                    ...
                    <div class="vk-news__left">
                        <div class="vk-sidebar">
                            <div class="vk-sidebar__box">
                                ...
                                <img src="{{asset('upload/hinhanh/'.$adv->photo)}}" alt="" class="img-fluid">
                            </div> <!--./box-->
