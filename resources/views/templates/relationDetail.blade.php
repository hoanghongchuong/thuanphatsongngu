        ...
        <nav class="container">
            <div class="vk-breadcrumb__wrapper">
                <ul class="vk-list vk-list--inline vk-breadcrumb__list">
                    ...
                    <li class="vk-list__item"><a href="{{url('quan-he-co-dong')}}">@if($lang == 'vi') {{$biendich[31]->name_vi}} @elseif($lang == 'en') {{$biendich[31]->name_en}}  @endif</a></li>
            ...
            <div class="row">
                <div class="col-lg-9">
                    <div class="vk-news__left">
                        <h1 class="vk-page__heading vk-page__heading--news-detail">@if($lang == 'vi') {{$data->name}} @elseif($lang = 'en') {{$data->name_en}} @endif</h1>
                        ...
                        <div class="vk-news__related">
                            ...
                            @foreach($relatedNews as $relate)
                                <li class="vk-list__item">
                                    <a href="news-detail.html" title="">@if($lang == 'vi'){{$relate->name}} @elseif($lang =='en') {{$relate->name_en}} @endif</a>
                                </li>
                            @endforeach    
                            </ul>
                        </div>
