...
Route::get('quan-he-co-dong','IndexController@relationships');
Route::get('quan-he-co-dong/{alias}.html','IndexController@relationshipsDetail');

Route::get('su-khac-biet','IndexController@suKhacBiet');
Route::get('su-khac-biet/{alias}.html','IndexController@differentDetail');
...
Route::post('search/job', 'IndexController@searchJob')->name('searchJob');
