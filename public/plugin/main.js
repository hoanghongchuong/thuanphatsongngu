...
var MetaMenu = function () {
    var _initInstances = function () {

        var metaMenu = $('#metaMenu');
        var itemHasMetaMenu = $('.has-meta-menu')

        //display meta menu
        itemHasMetaMenu.on('mousemove',function(){
            showMetaMenu();
        })

        //hidden meta menu
        itemHasMetaMenu.siblings().on('mousemove',function(){
            hiddenMentaMenu();
        })
        ...
        //action defined
        var hiddenMentaMenu = function(){
            itemHasMetaMenu.removeClass('active');
            metaMenu.css({
                'visibility':'hidden',
                'opacity':0,
            });
        ...
        var showMetaMenu = function(){
            itemHasMetaMenu.addClass('active');
            metaMenu.css({
                'visibility':'visible',
                'opacity':1,
            });
...
var Slider = function () {
    ...
    var homepageSlider = function () {
        ...
        $('.vk-slider[data-slider="banner"]').slick({
            arrows: false,
            slidesToShow: 1,
            dots: true,
            autoplay:true,
            dotsClass: 'vk-arrow-dot vk-list vk-list--inline',
            // autoplay: true,
            // fade: true,
            responsive: [{
                breakpoint: 768,
    ...
    var shopSlider = function () {
        ...
        $('[data-slider="shop-modal"]').slick({
            nextArrow: '<button  class="vk-btn vk-arrow next"><img src="'+ baseUrl() +'/public/images/icon/arrow-right.png"></button>',
            prevArrow: '<button  class="vk-btn vk-arrow prev"><img src="'+ baseUrl() +'/public/images/icon/arrow-left.png"></button>',
            slidesToShow: 1,
            infinite:false,

        })
        $('.modal').on('shown.bs.modal', function (e) {
            $('[data-slider="shop-modal"]').resize();
        })
...
var CustomTheme = function () {
    ...
    var _initInstances = function () {
        ...
        $("#parent").on('click','.vk-cate__arrow',function(e){

            $(this).parents("#parent").find('.vk-cate__title').removeClass('active');
